...
import ch02annotation.custom.annotations.ModelDescriptionPrint;
import ch02annotation.custom.annotations.ModelDescriptionPrints;
...
//    }
    ...
    // 1년마다 엔진오일 교체 필요
    public boolean isNeedChangeEngineOil() {
