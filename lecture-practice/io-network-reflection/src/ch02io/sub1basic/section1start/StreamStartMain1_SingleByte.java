...
public class StreamStartMain1_SingleByte {
...
/*       파일에 데이터를 출력하는 스트림
        ...
        FileOutputStream fileOutputStream = new FileOutputStream("io-network-reflection/temp/hello.dat", true); //.dat: data
        ...
        // 1바이트씩 읽어온다
        System.out.println(fileInputStream.read()); //65
        System.out.println(fileInputStream.read()); //66
        System.out.println(fileInputStream.read()); //67
        System.out.println(fileInputStream.read()); //-1  -> 읽을 게 없다, 파일의 끝 EOF(End of File)
